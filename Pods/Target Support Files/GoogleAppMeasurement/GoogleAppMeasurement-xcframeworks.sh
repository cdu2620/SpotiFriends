...
install_xcframework "${PODS_ROOT}/GoogleAppMeasurement/Frameworks/GoogleAppMeasurementIdentitySupport.xcframework" "GoogleAppMeasurementIdentitySupport" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
